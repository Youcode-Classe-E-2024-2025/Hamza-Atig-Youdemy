                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content w-[600px] p-6 grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <ul class="space-y-3">
                                    <li>
                                        <a href="#" class="flex items-center text-gray-700 hover:text-purple-600 transition duration-300">
                                    ...
                                    <li>
                                        <a href="#" class="flex items-center text-gray-700 hover:text-purple-600 transition duration-300">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-500">Master Python for data analysis and machine learning.</p>
                                            </div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="flex items-center text-gray-700 hover:text-purple-600 transition duration-300">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-500">Build cross-platform mobile apps with Flutter.</p>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="col-span-2 mt-4">
                                <div class="flex justify-between">
                                    ...
                                    <a href="#roadmap" class="text-purple-600 hover:text-purple-700 transition duration-300">
